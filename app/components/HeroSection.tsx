...
const HeroSection = () => {
    ...
    <div className=" flex flex-col-reverse md:flex md:flex-row md:justify-between  text-[13px] md:text-[16px] p-3 md:p-8 mt-16">
            ...
            <h1 className="flex flex-col text-xl md:text-4xl font-bold text-secondary">Jafrana Construction Works</h1>
            ...
            <div className="flex flex-col items-center justify-center p-2 relative m-1 ">
                ...
                <Image src={heroImage} alt="hero" width="0" height="0" sizes="100vw" 
                    className=' w-full h-auto  shadow-secondary shadow-xs z-20'/>

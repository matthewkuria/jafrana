...
const page = () => {
  return (
    <main className=" flex flex-col p-1">
      <section className="flex flex-col items-center justify-center min-h-[300px] md:min-h-[450px] lg:min-h-[490px] projects">
          <div className="bg-slate-900  py-1 px-4 md:px-4 lg:px-6 lg:pt-3 lg:pb-4">

...
const page = () => {
  return (
    <main className="services  flex  flex-col items-center justify-center w-full">
      <h1 className={`${bebas_neue.className} text-3xl text-primary underline decoration-primary`}>Services</h1>
      <article className='bg-quaternary flex flex-col md:flex md:flex-row items-center justify-around w-full'>
